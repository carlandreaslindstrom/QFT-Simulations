...
set title "Free Theory Vacuum Phasor: Modulus Error and Argument Error vs. Time Step" 
...
GNUTERM = "aqua"
GPFUN_f1 = "f1(x) = a*x + b"
a = 0.0359123494301583
b = -4.18982098531674e-05
FIT_CONVERGED = 1
FIT_NDF = 7
FIT_STDFIT = 0.000113679669357289
FIT_WSSR = 9.04614705762776e-08
plot 'FreeTheoryAccuracyErrorVsDt.txt' using 1:2 title "Modulus Error", 'FreeTheoryAccuracyErrorVsDt.txt' using 1:3 title "Argument Error"
## fit f1(x) 'FreeTheoryIntegrationAccuracy.txt' using 1:2 via a,b
#    EOF
